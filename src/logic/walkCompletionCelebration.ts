...
const asset = (variant: string): CelebrationAssetReference => ({
  provider: 'local',
  // The shipped mascot is the only approved raster today. Future curated
  // variants can swap this path (or provider) independently of data logic.
...
export const CELEBRATION_LIBRARY: CelebrationDefinition[] = [
  { id: 'thank-you-heart', category: 'thanks', rarity: 'common', eyebrow: 'הטיול הושלם', title: 'תודה על הטיול! ♥', message: 'טופי שולח/ת חיבוק גדול על הזמן יחד.', accent: '♥', confetti: false, mascotState: 'success', asset: asset('thank-you-heart') },
  { id: 'happy-jump', category: 'playful', rarity: 'common', eyebrow: 'יששש!', title: 'קפיצת שמחה של טופי', message: 'עוד טיול מעולה נכנס ליומן המשפחתי.', accent: '✦', confetti: false, mascotState: 'excited', asset: asset('happy-jump') },
  { id: 'high-five', category: 'thanks', rarity: 'common', eyebrow: 'משימה הושלמה', title: 'כיף! מגיע לך היי־פייב', message: 'טופי אומר/ת: עשית עבודה נהדרת.', accent: '✋', confetti: false, mascotState: 'ready', asset: asset('high-five') },
  ...
  { id: 'paw-party', category: 'playful', rarity: 'common', eyebrow: 'כפה של תודה', title: 'כף אל כף! 🐾', message: 'טופי כבר מחכה להרפתקה הבאה איתך.', accent: '🐾', confetti: false, mascotState: 'excited', asset: asset('paw-party') },
  ...
  { id: 'sleepy-good-night', category: 'night', rarity: 'common', eyebrow: 'טיול לילה הושלם', title: 'לילה טוב מטופי 🌙', message: 'תודה על הסיבוב האחרון להיום. עכשיו זמן למנוחה נעימה.', accent: '☾', confetti: false, mascotState: 'idle', timeOfDay: 'night', asset: asset('sleepy-good-night') },
  { id: 'long-walk', category: 'achievement', rarity: 'uncommon', eyebrow: 'וואו, איזה סיבוב!', title: 'טיול ארוך במיוחד', message: 'טופי מתרשם/ת מההשקעה — זה בהחלט ראוי לחגיגה.', accent: '★', confetti: true, mascotState: 'success', minimumWalkDuration: 45, rewardTeaser: 'רמז: הטיולים הארוכים נספרים', asset: asset('long-walk') },
  { id: 'special-surprise', category: 'surprise', rarity: 'rare', eyebrow: 'הפתעה קטנה מטופי', title: 'היום את/ה כוכב/ת!', message: 'רגע נדיר של שמחה במיוחד בשבילך.', accent: '✧', confetti: true, mascotState: 'excited', asset: asset('special-surprise') },
];
