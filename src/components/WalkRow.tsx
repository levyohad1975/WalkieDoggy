...
export function WalkRow({
  ...
  const metadataLine = walkMetadataLine(walk);
    ...
    >
      <View style={styles.mainRow}>
        <View style={styles.dateTimeBlock}>
          <RtlText style={[styles.time, historyCompact && styles.timeHistory]} numberOfLines={1}>
            {walk.scheduledTime}
          </RtlText>
          <RtlText style={styles.date} numberOfLines={1}>
        ...
        <View style={styles.leftBlock}>
          <StatusBadge status={walk.status} overdue={overdue} />
