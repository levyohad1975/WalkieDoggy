...
const styles = StyleSheet.create({
  ...
  dashboardTopSurface: { marginHorizontal: -spacing.md, marginTop: -spacing.xs, paddingHorizontal: spacing.md, paddingTop: spacing.xs, paddingBottom: 32, marginBottom: -32, backgroundColor: '#E8ECFF', borderBottomLeftRadius: 36, borderBottomRightRadius: 36 },
  ...
  dashboardShortcut: { flex: 1, minHeight: 58, borderRadius: 18, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 6, gap: 0, borderWidth: 1, borderColor: '#FFFFFFAA' },
  ...
  dashboardShortcutIcon: { fontSize: 21, lineHeight: 23 },
  dashboardLastWalk: { minHeight: 62, borderRadius: radii.xl, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#EAE5DD', paddingHorizontal: spacing.md, flexDirection: 'row-reverse', alignItems: 'center', gap: spacing.sm, shadowColor: '#17245B', shadowOpacity: 0.06, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 2 },
